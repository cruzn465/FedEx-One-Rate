...
function initAd() {
  ...
  //---------- START ANIMATION ------------
  tl.addLabel("start")
    .set("#c1_a, #c1_b, #c1_c, #c1_d, #c1_e, #c1_f, #c2_a, #c2_b, #c2_c, #c2_d, #c2_e, #c2_f, #legal, #ctaCopy, #ctaArrow", { opacity: 0, force3D: true })
    .set(" #c1_a, #c1_b, #c1_c, #c1_d, #c1_e, #c1_f, #c2_a, #c2_b, #c2_c, #c2_d, #c2_e, #c2_f", { x: 80, force3D: true })
  ...
  tl.addLabel("frame1", "")
    ...
    .staggerTo("#c1_b, #c1_c, #c1_d, #c1_e, #c1_f", .5, { x: 0, opacity: 1, ease: Quad.easeOut }, .1, "frame1+=0.8")
    .to('#legal', 0.5, { x: 0, opacity: 1, ease: Quad.easeOut }, "frame1+=1.75");

  //---------- Frame 2 ------------
  tl.addLabel("frame2", "3")
    .to(' #c1_a, #c1_b, #c1_c, #c1_d, #c1_e, #c1_f', 0.5, { opacity: 0, ease: Power4.easeInOut }, "frame2+=0")
    ...
    .fromTo('#ctaArrow', .5, { x: "0" }, { rotationZ: '0deg', x: 10, ease: Quad.easeOut, force3D: true }, "frame2+=3")
