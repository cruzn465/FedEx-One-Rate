...
function initAd() {
  ...
  //---------- START ANIMATION ------------
  tl.addLabel("start")
    .set("#c1_a, #c1_b, #c2_a, #legal, #ctaCopy, #ctaArrow", { opacity: 0, force3D: true })
    .set(" #c1_a, #c1_b, #c2_a", { x: 80, force3D: true })
  ...
  tl.addLabel("frame1", "")
    ...
    .staggerTo(" #c1_b ", .5, { x: 0, opacity: 1, ease: Quad.easeOut }, .1, "frame1+=0.8")
    .to('#legal', 0.5, { x: 0, opacity: 1, ease: Quad.easeOut }, "frame1+=1.2");
  ...
  tl.addLabel("frame2", "3")
    ...
    .to('#ctaArrow', .3, { rotationZ: '0deg', x: 0, ease: Quad.easeIn }, "frame2+=3.0");
