...
function init(){
    ...
    function ctaOver(e) {
        if (ctaArr_2x.style.opacity == 1) {
          TweenLite.fromTo(ctaArr_2x, .5, { rotationZ: '0deg' }, { rotationZ: '0deg', x: 6, ease: Quad.easeOut, force3D: true });
          // tl
          //   .fromTo(ctaArr_2x, 0.5, { x: 0 }, { x: 6, ease: Power2.easeOut, force3D: true })
        }
      }
    
      function ctaOut(e) {
        if (ctaArr_2x.style.opacity == 1) {
          TweenLite.to(ctaArr_2x, .3, { rotationZ: '0deg', x: 0, ease: Quad.easeIn });
          // tl
          //   .to(ctaArr_2x, 0.3, { x: 0, ease: Power1.easeIn, force3D: true })
        }
    ...
    .fromTo(ctaArr_2x, .5, { x: "0" }, { rotationZ: '0deg', x: 6, ease: Quad.easeOut, force3D: true }, "+=0")
