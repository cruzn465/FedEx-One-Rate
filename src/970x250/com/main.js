...
function init(){
    ...
    function ctaOver(e) {
        if (ctaArr_2x.style.opacity == 1) {
          TweenLite.fromTo(ctaArr_2x, .5, { rotationZ: '0deg' }, { rotationZ: '0deg', x: 15, ease: Quad.easeOut, force3D: true });
          // tl
    ...
    .fromTo(ctaArr_2x, .5, { x: "0" }, { rotationZ: '0deg', x: 15, ease: Quad.easeOut, force3D: true }, "+=0")
